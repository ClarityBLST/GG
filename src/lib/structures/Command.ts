...
export default abstract class Command {
  ...
  public readonly memberPermissions: Readonly<
    BitField<PermissionsString, bigint>
  >;
  public readonly clientPermissions: Readonly<
    BitField<PermissionsString, bigint>
  >;
  ...
  public constructor(client: BaseClient, options: CommandOptions) {
    ...
    this.memberPermissions = new PermissionsBitField(
