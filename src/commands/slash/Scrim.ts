...
export default class extends Command {
    ...
    public async execute(interaction: ChatInputCommandInteraction<"cached" | "raw">) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`**${organization.name}** has scheduled a new BloodStrike scrim`)
                .setColor(0x2ECC71)
                .addFields([
                    { name: "📅 Date", value: date, inline: true },
                    { name: "🔢 Max Teams", value: maxTeams.toString(), inline: true },
                    { name: "🆔 Scrim ID", value: result.insertedId.toString(), inline: true },
                    {
                        name: "⏰ Regional Times",
                        value: [
                ...
                .setFooter({ text: "Use /open_registration when ready to accept teams" })
                .setTimestamp();
        ...
        try {
            ...
            if (channel?.isTextBased()) {
                const logEmbed = new EmbedBuilder()
                    ...
                    .setColor(0x3498DB)
                    .setDescription(`**${scrim.name}** created by <@${interaction.user.id}>`)
                    .addFields([
    ...
    private async replyError(interaction: ChatInputCommandInteraction, message: string) {
