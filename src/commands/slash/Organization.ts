...
export default class extends Command {
  protected admin = "1336144139397365831";
  ...
  public async execute(
    ...
    try {
      ...
      if (orgExists) {
        const embed = new EmbedBuilder()
          ...
          .addFields([
            ...
            {
              name: "Created by",
              value: `<@${orgExists.createdBy}>`,
              inline: true,
            },
            {
              name: "Date",
              value: orgExists.createdAt.toLocaleDateString(),
              inline: true,
            },
          ]);
      ...
      const successEmbed = new EmbedBuilder()
        ...
        .setFooter({
          text: "This key will be needed to manage the organization",
        })
        .setTimestamp();
        ...
        const dmEmbed = new EmbedBuilder()
          ...
          .addFields([
            { name: "Your Key", value: `\`${key}\`` },
            {
              name: "Instructions",
              value:
                "Use this key with commands like `/register-match <key> ...`",
            },
      ...
      await interaction.reply({
        embeds: [
          new EmbedBuilder()
            .setColor(0xff0000)
            .setDescription(
              "❌ Unexpected error while creating the organization. Please try again."
            ),
        ],
        ephemeral: true,
      });
      ...
      if (
        ...
        const logEmbed = new EmbedBuilder()
          ...
          .addFields([
            ...
            {
              name: "👤 Created by",
              value: `<@${data.creatorId}> (\`${data.creatorId}\`)`,
            },
            {
              name: "🛡️ Admin",
              value: `<@${data.adminId}> (\`${data.adminId}\`)`,
            },
